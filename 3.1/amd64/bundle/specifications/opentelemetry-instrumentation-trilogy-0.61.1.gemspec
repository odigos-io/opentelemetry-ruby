...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_dependency(%q<opentelemetry-helpers-mysql>.freeze, [">= 0"])
    s.add_dependency(%q<opentelemetry-helpers-sql>.freeze, [">= 0"])
    s.add_dependency(%q<opentelemetry-helpers-sql-obfuscation>.freeze, [">= 0"])
    s.add_dependency(%q<opentelemetry-instrumentation-base>.freeze, ["~> 0.23.0"])
    s.add_dependency(%q<opentelemetry-semantic_conventions>.freeze, [">= 1.8.0"])
  end
end
