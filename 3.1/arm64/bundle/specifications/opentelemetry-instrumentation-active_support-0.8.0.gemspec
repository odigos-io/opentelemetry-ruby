# -*- encoding: utf-8 -*-
# stub: opentelemetry-instrumentation-active_support 0.8.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/open-telemetry/opentelemetry-ruby-contrib/issues", "changelog_uri" => "https://rubydoc.info/gems/opentelemetry-instrumentation-active_support/0.8.0/file/CHANGELOG.md", "documentation_uri" => "https://rubydoc.info/gems/opentelemetry-instrumentation-active_support/0.8.0", "source_code_uri" => "https://github.com/open-telemetry/opentelemetry-ruby-contrib/tree/main/instrumentation/active_support" } if s.respond_to? :metadata=
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_development_dependency(%q<opentelemetry-sdk>.freeze, [">= 0"])
    ...
    s.add_dependency(%q<opentelemetry-sdk>.freeze, [">= 0"])
