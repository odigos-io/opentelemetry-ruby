# -*- encoding: utf-8 -*-
# stub: opentelemetry-instrumentation-rails 0.36.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<opentelemetry-instrumentation-action_pack>.freeze, ["~> 0.12.0"])
    ...
    s.add_development_dependency(%q<rack-test>.freeze, ["~> 2.1.0"])
    ...
    s.add_dependency(%q<opentelemetry-instrumentation-action_mailer>.freeze, ["~> 0.4.0"])
    s.add_dependency(%q<opentelemetry-instrumentation-action_pack>.freeze, ["~> 0.12.0"])
    s.add_dependency(%q<opentelemetry-instrumentation-action_view>.freeze, ["~> 0.9.0"])
    s.add_dependency(%q<opentelemetry-instrumentation-active_job>.freeze, ["~> 0.8.0"])
    s.add_dependency(%q<opentelemetry-instrumentation-active_record>.freeze, ["~> 0.9.0"])
    s.add_dependency(%q<opentelemetry-instrumentation-active_storage>.freeze, ["~> 0.1.0"])
    s.add_dependency(%q<opentelemetry-instrumentation-active_support>.freeze, ["~> 0.8.0"])
    ...
    s.add_dependency(%q<rack-test>.freeze, ["~> 2.1.0"])
