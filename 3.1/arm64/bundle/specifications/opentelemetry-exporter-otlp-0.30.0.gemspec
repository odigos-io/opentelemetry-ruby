...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_dependency(%q<googleapis-common-protos-types>.freeze, ["~> 1.3"])
    s.add_dependency(%q<google-protobuf>.freeze, [">= 3.18"])
    s.add_dependency(%q<opentelemetry-api>.freeze, ["~> 1.1"])
    s.add_dependency(%q<opentelemetry-common>.freeze, ["~> 0.20"])
    s.add_dependency(%q<opentelemetry-sdk>.freeze, ["~> 1.2"])
    ...
    s.add_dependency(%q<webmock>.freeze, ["~> 3.24"])
